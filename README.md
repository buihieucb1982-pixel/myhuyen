...
Ví dụ prompt :
# PROMPT THIẾT KẾ WEBSITE PORTFOLIO UI/UX
...
* Giao diện mềm mại, sang trọng, nữ tính
* Có animation mượt khi hover
...
* Nghề nghiệp:
  “Sinh viên khoa CNTT - Đồ họa kỹ thuật số”
* Câu slogan:
  “Nghệ thuật nằm ở cách tôi nhìn thế giới.”
* Nút:
...
Hiển thị dạng progress bar animation.
...
Mô tả:
Thiết kế giao diện hiện đại bằng Figma theo phong cách tối giản.
...
Nội dung:
“Thiết kế và xây dựng website giới thiệu bản thân”
...
* Gmail:
  [hn35705@gmail.com](mailto:hn35705@gmail.com)
* Phone:
  0978400955

Hiển thị social icon:
...
Hiển thị:
“© 2026 Nguyễn Thị Khánh Huyền — UI/UX Designer Portfolio”
